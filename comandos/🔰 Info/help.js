        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.EmbedBuilder()
                    ...
                    .setFooter({ text: `© desarrollado por ! MrDxniezz#2048 | 2022`, iconURL: `https://cdn.discordapp.com/attachments/920687521929764894/1023075921659449344/Gloom.png` })
            ...
            .setColor(client.color)
            .setDescription(`Bot Multifuncional en desarrollo por \`! MrDxniezz#2048\``)
            ...
            .addFields([{name: `📈 **__ESTADÍSTICAS__**`, value: `⚙ **${client.commands.size} Comandos**\n📁 en **${client.guilds.cache.size} Servidores**\n📶 **\`${client.ws.ping}ms\` Ping**\n👤 desarrollado por **[! MrDxniezz#2048](https://cdn.discordapp.com/attachments/920687521929764894/1023075921659449344/Gloom.png)**`}], )
            .addFields([{name: `✍ **__CÓDIGO PRIVADO__**`, value: `[\`MI FOTO DE PERFIL!\`](https://cdn.discordapp.com/attachments/920687521929764894/1023075921659449344/Gloom.png)`}], )
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n© desarrollado por ! MrDxniezz#2048 | 2022`, iconURL: `https://cdn.discordapp.com/attachments/920687521929764894/1023075921659449344/Gloom.png` })
